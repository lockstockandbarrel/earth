...
integer, parameter :: ucs4  =   selected_char_kind ('ISO_10646')
   ...
   write(*,*)' only 0 to 127 is defined in ASCII, 128-255 specifically not defined in UTF-8;'
   write(*,*)' but often used for extended ASCII such as latin1 or latin2 encoding, or extended'
